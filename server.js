...
setInterval(() => {
  http.get(`http://music-kapos.glitch.me/`);
}, 280000);
...
const youtube = new YouTube("AIzaSyBAFHyBNgFl0of3F5lYZwn9WNjNrwxzOE0");
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBAFHyBNgFl0of3F5lYZwn9WNjNrwxzOE0";
...
client.on("ready", async () => {
  ...
  let g = client.guilds.get("684494230600679460"); // id server
  let c = g.channels.get("686556803697606698"); // id channel
  if (c.type === "voice") {
    c.join();
    setInterval(() => {
      if (
